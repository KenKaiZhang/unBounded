...
router.get("/create-client", async (req, res) => {
...
// create order
router.post("/orders/create-order", getCustomer, async (req, res) => {
  try {
...
async function createOrder(cart) {
  const purchaseAmount = cart.total; // TODO: pull prices from a database
