async function showAvailableCountries() {
  ...
  await fetch("https://data.unboundedsw.com/brands/options/countries", {
    method: "GET",
    headers: {
...
async function showBrands(country = "everywhere") {
  ...
  await fetch(`https://data.unboundedsw.com/brands/country/${country}`, {
    method: "GET",
    headers: {
      Accept: "application/json",
    },
...
async function showBrandName() {
  ...
  if (request.brand === undefined) {
    ...
    fetch(`https://data.unboundedsw.com/brands/${request.brand}`, {
      method: "GET",
      headers: {
        Accept: "application/json",
      },
...
async function showProductInformation() {
  ...
  await fetch(`https://data.unboundedsw.com/products/${selectedProduct}`, {
    method: "GET",
    headers: {
      Accept: "application/json",
    },
...
async function showProducts() {
  ...
  await fetch("https://data.unboundedsw.com/products/filter", {
    method: "POST",
    headers: {
      Accept: "application/json",
...
async function showCart() {
  ...
  await fetch(`https://data.unboundedsw.com/customers/${customerId}/cart`, {
    method: "GET",
    headers: {
      Accept: "application/json",
    },
...
async function showBasicInformation() {
  ...
  const customerId = document.cookie.split("userId=")[1];
  await fetch(`https://data.unboundedsw.com/customers/${customerId}`, {
    method: "GET",
    headers: {
      Accept: "application/json",
    },
